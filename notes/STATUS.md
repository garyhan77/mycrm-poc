...
**Last updated: 2026-08-12.** This is a snapshot, not history — for how we got here, see [[daily/]]; for why things were built the way they were, see [[../docs/06-decisions|Decision records]].
...
- **48 automated tests passing** (17 backend unit, 10 backend e2e, 21 frontend component), plus a 10-check live browser acceptance walkthrough covering every story end-to-end — all green. See [[../docs/05-test-plan|Test plan]] for what each layer covers and the four real bugs caught along the way.
...
- **The activity/audit trail has no UI yet** — it's backend/API only (`GET /api/customers/:id/activity`), by explicit choice for this phase. See [[../docs/01-requirements|Requirements]]'s extension section.
...
- [[../docs/01-requirements|Requirements]], [[../docs/05-test-plan|Test plan]], [[../docs/06-decisions|Decision records]], [[../docs/07-azure-deployment|Azure deployment]]
